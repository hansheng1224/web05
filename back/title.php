    ...
    <form method="post"  action="./api/edit.php">
        ...
        foreach($rows as $row){
            ...
            <tr>
                    ...
                    <td width="7%">
                        <input type="radio" name="radio" id="" value="<?=$row['id'];?>" <?=$checked;?>>
                    </td>
                    <td width="7%">
                        <input type="checkbox" name="del[]" id="" value="<?=$row['id'];?>">
                    </td>
                    <td>
                        <input type="button" value="更新圖片" onclick="op('#cover','#cvr','./mpdal/upload_title.php?id=<?=$row['id'];?>')">
